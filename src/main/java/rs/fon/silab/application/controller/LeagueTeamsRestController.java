...
public class LeagueTeamsRestController {
    ...
    public List<LeagueTeamsDto> findAllLeagues(@PathVariable Long team) {
        return ltService.findAllLeagues(team);
    }
    ...
    public ResponseEntity<Object> update(@PathVariable Long league, @PathVariable Long team, @Valid @RequestBody LeagueTeamsDto ltDto) {
        try {
